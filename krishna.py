...
TOKEN = '8129348112:AAGaWqucfopQI6mBU285Tfqv8_o2UUS3AA8'
...
def attack_command(message):
    ...
    try:
        ...
        bot.send_message(chat_id, "Please  provide host Port sec.")
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*FOR RESSELER SHIP DM :-@ARMYY_OP*", parse_mode='Markdown')
